from uitest_device_farm import uitest_device_farm
...
args = {}
args['circleci_root_directory'] = ""
args['appname'] = "PhotoAlbum"
args['app_repo_root_directory'] = ""
try:
    uitest_device_farm(circleci_root_directory = args['circleci_root_directory'],
